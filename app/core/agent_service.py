...
- Si search_catalog confirma que un producto que el cliente pidió NO está en el catálogo, llama a registrar_demanda_no_cubierta con ese producto ANTES de ofrecer una alternativa o de escalar por ese motivo.
